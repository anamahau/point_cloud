...
class dataRecorder:
    ...
    def save(self, msgNumber):
        ...
        self.depth_img = rospy.wait_for_message('/camera2/camera/aligned_depth_to_color/image_raw', Image, timeout=10)
        rospy.loginfo('waiting for rgb_img message...')
        # self.rgb_img = rospy.wait_for_message('/rgbd/rgb/image_raw', Image, timeout=10)
        self.rgb_img = rospy.wait_for_message('/camera2/camera/color/image_raw', Image, timeout=10)
        ...
        self.camera_info = rospy.wait_for_message('/camera2/camera/color/camera_info', CameraInfo, timeout=10)
